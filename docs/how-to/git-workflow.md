...
2. Generate message: @omni-orchestrator suggest_commit_message(spec_path="docs/specs/xxx.md")
...
| `docs/how-to/git-workflow.md` | Manual / Spec Kit | Human-readable documentation |
