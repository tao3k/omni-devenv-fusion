...
Architecture:
    ...
    └────────┬────────┘
             ...
             ▼ Reads
    ┌─────────────────┐
    │PythonSkillScanner│  ← Foundation Layer (Index Reader)
    └────────┬────────┘
             │
             ▼ Returns
    ┌─────────────────┐
    │DiscoveredSkill  │  ← Core Layer (Discovery Service)
    └────────┬────────┘
             │
             ▼ Used by
    ┌─────────────────┐
    │   Kernel        │  ← Consumes DiscoveredSkill objects
    └─────────────────┘
"""
...
class SkillDiscoveryService:
    ...
    def discover_all(self, locations: list[str] | None = None) -> List[DiscoveredSkill]:
        ...
        """
        logger.debug("🔍 Accessing Skill Index...")
        ...
        logger.info(f"📦 Index Service provided {len(all_skills)} skills")
        return all_skills
