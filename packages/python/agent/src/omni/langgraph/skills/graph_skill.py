"""
omni/langgraph/skills/graph_skill.py - GraphSkill Base Class
...
class GraphSkill(ABC):
    ...
    def __init__(self, skill_runner: Any = None) -> None:
        """Initialize the GraphSkill.

        Args:
            skill_runner: Optional skill runner for executing sub-skills
        """
        self._skill_runner = skill_runner
        self._compiled_graph: Any | None = None

    def get_skill_runner(self) -> Any:
        """Get the skill runner."""
        return self._skill_runner

    def set_skill_runner(self, skill_runner: Any) -> None:
    ...
    def compile(self) -> Any:
        ...
        builder = DynamicGraphBuilder(skill_runner=self._skill_runner)
    ...
    async def run(self, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        if self._compiled_graph is not None:
            ...
            if isinstance(self._compiled_graph, CompiledGraph):
...
def create_graph_skill_from_blueprint(
    ...
    Args:
        ...
        skill_runner: Skill runner for executing sub-skills
    ...
    class DynamicGraphSkill(GraphSkill):
        ...
        required_skills = blueprint.required_skills or []
    ...
    return DynamicGraphSkill(skill_runner=skill_runner)
