"""
agent/skills/core/skill_manifest_loader.py
...
class SkillManifestLoader:
    ...
    async def load_metadata(self, skill_path: Path) -> SkillMetadata | None:
        ...
        try:
            ...
            model = SkillManifestModel.model_validate(meta)
    ...
    def compare_versions(v1: str, v2: str) -> int:
        ...
        p1 = SkillManifestLoader.parse_version(v1)
        p2 = SkillManifestLoader.parse_version(v2)
...
_loader: SkillManifestLoader | None = None


def get_manifest_loader() -> SkillManifestLoader:
    """Get the global manifest loader instance."""
    global _loader
    if _loader is None:
        _loader = SkillManifestLoader()
    return _loader
