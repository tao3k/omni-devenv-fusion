...
class SkillDiscovery:
    ...
    def find_by_id(self, skill_id: str) -> dict[str, Any] | None:
        """
    ...
    def suggest_for_query(self, query: str) -> dict[str, Any]:
        """
    ...
    def get_installation_info(self, skill_id: str) -> dict[str, Any] | None:
        """
...
def suggest_for_task(task: str) -> dict[str, Any]:
    """
