...
if TYPE_CHECKING:
    from ....core.orchestrator.builder import DynamicGraphBuilder
...
class GraphSkill(ABC):
    ...
    def __init__(self, skill_manager: SkillContext | None = None) -> None:
        """Initialize the GraphSkill.

        Args:
            skill_manager: Optional SkillContext for skill lookups
        """
        self._skill_manager = skill_manager
        self._compiled_graph: Any | None = None

    def get_skill_manager(self) -> SkillContext | None:
        """Get the skill manager."""
        return self._skill_manager

    def set_skill_manager(self, skill_manager: SkillContext) -> None:
...
def create_graph_skill_from_blueprint(
    ...
    Args:
        ...
        skill_manager: SkillContext for skill lookups
