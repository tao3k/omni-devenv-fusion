...
"""
Router Functions - Semantic Tool Routing
...
from common.mcp_core import log_decision, PERSONAS, build_persona_prompt
...
log_decision("router_functions.loaded", {}, logger)
