//! Full workflow integration test for omni-scanner.
//!
//! Tests the complete scanning workflow: SKILL.md + scripts.

use omni_scanner::VERSION;
...
"#,
    ...
    fs::write(
        ...
        r#"---
name: git
description: Use when working with version control.
metadata:
  author: omni-dev-fusion
  version: "1.0"
...
metadata:
  author: omni-dev-fusion
  version: "2.0.0"
  source: "https://github.com/tao3k/omni-dev-fusion/tree/main/assets/skills/python"
  routing_keywords:
    - "python"
    - "py"
  intents:
...
metadata:
  author: omni-dev-fusion
  version: "1.5.0"
  source: "https://github.com/tao3k/omni-dev-fusion/tree/main/assets/skills/rust"
  routing_keywords:
    - "rust"
    - "cargo"
  intents:
