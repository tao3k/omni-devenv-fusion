//! PyO3 bindings for ZK Note Enhancement Engine.
//!
...
pub fn zk_enhance_note(path: &str, title: &str, content: &str) -> PyEnhancedNote {
    let input = NoteInput {
        path: path.to_string(),
...
pub fn zk_enhance_notes_batch(notes: Vec<(String, String, String)>) -> Vec<PyEnhancedNote> {
...
pub fn zk_parse_frontmatter(content: &str) -> PyNoteFrontmatter {
    PyNoteFrontmatter {
