//! Tests for zk entity reference extraction.

use omni_knowledge::zk::{
    ZkEntityRef, ZkRefStats, extract_entity_refs, find_notes_referencing_entity, get_ref_stats,
    is_valid_entity_ref, parse_entity_ref,
};
...
fn test_ref_stats() {
    ...
    let stats = ZkRefStats::from_refs(&refs);
