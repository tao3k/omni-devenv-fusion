...
- (**mcp**) add ast-grep code intelligence tools for structural search and refactoring - ([9309e45](https://github.com/tao3k/omni-dev-fusion/commit/9309e45a993db902a86e37b44990a1371cc74021)) - guangtao
- (**mcp**) add instructions loader, lazy cache, and project context framework - ([4e4d8f7](https://github.com/tao3k/omni-dev-fusion/commit/4e4d8f75f3b10e6af96c55fb5720cd831b86c84f)) - guangtao
- (**mcp**) add Agentic OS with five pillars: Spec Kit, Memory, Flight Recorder, OODA Loop, Smart Publisher - ([8f43f8e](https://github.com/tao3k/omni-dev-fusion/commit/8f43f8e3e20828519adb9ce480d542cbba66e30e)) - guangtao
...
- change claude to MINIMAX_2.0 - ([3e78889](https://github.com/tao3k/omni-dev-fusion/commit/3e78889942de8fc57f7b26be95f12c73695967bf)) - guangtao
- add justfile  workflow - ([59a0f5f](https://github.com/tao3k/omni-dev-fusion/commit/59a0f5f3e8a5e1c2f67302db97b87d3d614c4371)) - guangtao
- add cog - ([b5fa13e](https://github.com/tao3k/omni-dev-fusion/commit/b5fa13e35a3e6aab44954ccf37548ba41f69b9a2)) - guangtao
- add cog - ([e0b793f](https://github.com/tao3k/omni-dev-fusion/commit/e0b793f7194c76301592017260806355b685b8b3)) - guangtao
- test lefthook - ([4cec8c0](https://github.com/tao3k/omni-dev-fusion/commit/4cec8c0c8dd0e395732bb60d4cc473dce1f1a30b)) - guangtao
#### Bug Fixes
- (**git-ops**) fix: ensure hot reload works by clearing sys.modules before reload - ([d5e9fe5](https://github.com/tao3k/omni-dev-fusion/commit/d5e9fe58f856ca685211cc52cc0a6e76f38795b1)) - guangtao
- (**mcp**) remove duplicate top-level import of polish_text - ([74dd8cd](https://github.com/tao3k/omni-dev-fusion/commit/74dd8cd07e23feca15a9f881d1234fc66fb98dd6)) - guangtao
- (**mcp**) fix spinner name and tokenizers parallelism - ([b5a59d5](https://github.com/tao3k/omni-dev-fusion/commit/b5a59d5193ead0977f202b69ae9ddd1d2838a167)) - guangtao
- (**mcp**) remove duplicate polish_text tool definition - ([2c07de3](https://github.com/tao3k/omni-dev-fusion/commit/2c07de3f7205eaf182f98b0c23f7285d27afb742)) - guangtao
- (**mcp-core**) resolve threading.Lock deadlock with pure lazy loading - ([b414e4e](https://github.com/tao3k/omni-dev-fusion/commit/b414e4ebe2da3a04a2d96e91df97f8c4f496beee)) - guangtao
- (**orchestrator**) convert test functions to use assert instead of return - ([8994394](https://github.com/tao3k/omni-dev-fusion/commit/89943941e67f2d6b26c0596b5a4af6a1496e5f58)) - guangtao
- resolve recursive call issues in skill tools and enhance tests - ([0bccc02](https://github.com/tao3k/omni-dev-fusion/commit/0bccc02f6639e7a163acc193db2098ec124d1782)) - guangtao
- correct dmerge import and lefthook commands path in lefthook.nix - ([5b08bb6](https://github.com/tao3k/omni-dev-fusion/commit/5b08bb646a9fcebd2faec463c4a9f86266f663ec)) - guangtao
- remove unsupported --no-pager flag from cog commands - ([282068e](https://github.com/tao3k/omni-dev-fusion/commit/282068e2747a3cec31a70796b8482b1f6509428e)) - guangtao
- stage all files before commit to capture hook changes - ([162336b](https://github.com/tao3k/omni-dev-fusion/commit/162336b95828cba17532a197ab5a8f34df6e8840)) - guangtao
- make the cog.toml to copy mode - ([65257d4](https://github.com/tao3k/omni-dev-fusion/commit/65257d4e1c2f67c7feb74ec15cb766ace1d04a09)) - guangtao
#### Documentation
- (**claude**) CLAUDE.md: add documentation classification and authorization rules - ([cd6b7f9](https://github.com/tao3k/omni-dev-fusion/commit/cd6b7f957b22b7a1f5ba3f1d01ef8ccfac37318c)) - guangtao
- (**cli**) add local developer memory section to project instructions - ([89ee35a](https://github.com/tao3k/omni-dev-fusion/commit/89ee35a6742feaad348a985807e84723c0312663)) - guangtao
- (**docs**) add rag usage guide and documentation standards - ([0a7f389](https://github.com/tao3k/omni-dev-fusion/commit/0a7f389651e9306075876b1b9abd07ebcdabdc6d)) - guangtao
- (**docs**) docs: rewrite README with Tri-MCP architecture and SDLC workflow - ([f19cdf1](https://github.com/tao3k/omni-dev-fusion/commit/f19cdf17a62f8a4a1c3533c34cf6dd6142a508d6)) - guangtao
- (**docs**) add vision and key differentiators to README - ([bc17ee0](https://github.com/tao3k/omni-dev-fusion/commit/bc17ee0f54a1551bd376f573ace5b1e0fef0e0a1)) - guangtao
- (**docs**) update CLAUDE.md to reference docs/how-to/git-workflow.md - ([e1eb26f](https://github.com/tao3k/omni-dev-fusion/commit/e1eb26ff75bde3953df795eecc5930955bb0e0d2)) - guangtao
...
- reorganize design documents to correct locations - ([42b913e](https://github.com/tao3k/omni-dev-fusion/commit/42b913eba7f7fd6630ea893b13b28a59a7425ac5)) - guangtao
- create agent/knowledge/ for problem-solution knowledge base - ([f3c49de](https://github.com/tao3k/omni-dev-fusion/commit/f3c49de35a9df744993703ddb59b85de770fe832)) - guangtao
- update git-workflow.md with Agent/LLM commit protocol - ([d2f79c7](https://github.com/tao3k/omni-dev-fusion/commit/d2f79c775d6fefa857af7a5ef01bcfcf5375812a)) - guangtao
- simplify CLAUDE.md and add lang_expert documentation - ([d70f549](https://github.com/tao3k/omni-dev-fusion/commit/d70f54931397420f4dfd5a4db1f96a3185534245)) - guangtao
- add default rules for config changes and agent-commit protocol - ([9f0611e](https://github.com/tao3k/omni-dev-fusion/commit/9f0611e3c9de5f0471bca26fbe3b283677c60c6b)) - guangtao
- clarify cog and conform roles in git workflow - ([8abeaa9](https://github.com/tao3k/omni-dev-fusion/commit/8abeaa9c6b04854487360a87ceec049f12ff840a)) - guangtao
- add commit message standard with project scopes - ([eb222e7](https://github.com/tao3k/omni-dev-fusion/commit/eb222e77748a6a255e826dd58aaae1e272e8e2e5)) - guangtao
- add Agent-Commit Protocol for safe AI git interactions - ([a91dc0c](https://github.com/tao3k/omni-dev-fusion/commit/a91dc0cb2d1d605465ccb3681a97fd1be4fe7cf9)) - guangtao
- enhance Explanation Trilogy with safety and self-healing - ([2f9f75a](https://github.com/tao3k/omni-dev-fusion/commit/2f9f75a664ccc5cd508c82ecad9fd0bc418adc2c)) - guangtao
- add Deep Explanation Trilogy and Diátaxis structure - ([2ef1cb0](https://github.com/tao3k/omni-dev-fusion/commit/2ef1cb091dc0b29b46590361610591c09e5abd58)) - guangtao
- rewrite Getting Started with writing standards - ([75cadd9](https://github.com/tao3k/omni-dev-fusion/commit/75cadd98058684874aaefc1ce9e34400a3dc7794)) - guangtao
- modularize writing standards into library - ([b0fd6db](https://github.com/tao3k/omni-dev-fusion/commit/b0fd6db7e4b6641c5e411fcb0f9ea9491df9d386)) - guangtao
- rewrite Getting Started as Why document - ([e7c47bd](https://github.com/tao3k/omni-dev-fusion/commit/e7c47bdef4aba2e0b0ba531b6211efab87fb933d)) - guangtao
- rewrite Getting Started as What & Why document - ([0b25595](https://github.com/tao3k/omni-dev-fusion/commit/0b2559560aee22691a86e49e423337e277afaa04)) - guangtao
- update README and add Getting Started guide - ([b79a9c2](https://github.com/tao3k/omni-dev-fusion/commit/b79a9c2a731cee072326f732fa434b2fd981fcc6)) - guangtao
- update CLAUDE.md with new tools and fix passive voice - ([d69f304](https://github.com/tao3k/omni-dev-fusion/commit/d69f3041e8362842f89fe39adda845fe9ead18be)) - guangtao
- update CLAUDE.md with new tools and fix passive voice - ([a0cc855](https://github.com/tao3k/omni-dev-fusion/commit/a0cc8552328a79ffa3327a4e432e6a29968bc6ff)) - guangtao
- add writing standards system with internalization - ([dd498f7](https://github.com/tao3k/omni-dev-fusion/commit/dd498f7fad7f06f71196365e55b3f149f4ca1634)) - guangtao
- improve README with full secretspec providers and acknowledgments - ([27f1be5](https://github.com/tao3k/omni-dev-fusion/commit/27f1be584010ed22d1ebf39bdc3df2a8265471d0)) - guangtao
- rewrite README with Orchestrator workflow and SRE health checks - ([ddc8127](https://github.com/tao3k/omni-dev-fusion/commit/ddc812725fc0ea6ad79fbe9014d5ed44a3674ad0)) - guangtao
- update module structure documentation - ([3f802a2](https://github.com/tao3k/omni-dev-fusion/commit/3f802a2f64439c8ea61926f917950553381de48e)) - guangtao
- add secretspec setup documentation with 1Password integration - ([b43ae98](https://github.com/tao3k/omni-dev-fusion/commit/b43ae98ea5e985fd5bf83c7b5da3f6b6707b67f7)) - guangtao
- init README - ([46fbf20](https://github.com/tao3k/omni-dev-fusion/commit/46fbf2078b13692d4056f74e7f5a32a0fc90e019)) - guangtao
#### Tests
- (**mcp**) add comprehensive test suite for all MCP tools - ([afd8f9e](https://github.com/tao3k/omni-dev-fusion/commit/afd8f9e9e7320ff95f4799d0251ded2f6cf15685)) - guangtao
...
- (**git-ops**) consolidate to git_commit only - ([5860508](https://github.com/tao3k/omni-dev-fusion/commit/58605088ce286b26c572976912d3a1f1253a6e7c)) - guangtao
- (**git-ops**) lift functions to module level for better testability - ([3d13b92](https://github.com/tao3k/omni-dev-fusion/commit/3d13b9203c916b9113ccfb45e8675361d89d7c53)) - guangtao
- (**git-workflow**) simplify to critical operations only - ([0ae012d](https://github.com/tao3k/omni-dev-fusion/commit/0ae012db517490c1f6f202b782911228b9404b9d)) - guangtao
- (**inference**) load API key from .mcp.json config file - ([08f523d](https://github.com/tao3k/omni-dev-fusion/commit/08f523ddb19dca3025ff5a7f28592b53dfa7c0d2)) - guangtao
...
- Transform Omni from Wrapper to Kernel architecture - ([49aaa05](https://github.com/tao3k/omni-dev-fusion/commit/49aaa05e7eb64a4401ae350680f409eb8b19dd5b)) - guangtao
- migrate src/ to packages/python/ architecture - ([bdd86ed](https://github.com/tao3k/omni-dev-fusion/commit/bdd86eda1864a39f926d5995c998aad6bdf3eac0)) - guangtao
- migrate from omni-devenv-fusion to omni-dev-fusion - ([b057f7c](https://github.com/tao3k/omni-dev-fusion/commit/b057f7c37c271ec3d9ca526a9cf86a1cdd2e0545)) - guangtao
- reorganize docs/ to follow four-category standard - ([57ead99](https://github.com/tao3k/omni-dev-fusion/commit/57ead99037aed572a77f580034932b360cb0fd4c)) - guangtao
- clean up Tri-MCP architecture and fix docs paths - ([1d60d4a](https://github.com/tao3k/omni-dev-fusion/commit/1d60d4a029e1fa15a232fc5b9bfc198c4f010536)) - guangtao
- reorganize nix modules into modules/ directory - ([202b1d6](https://github.com/tao3k/omni-dev-fusion/commit/202b1d693aa16c33dd812d3fc7a37899755de496)) - guangtao
#### Miscellaneous Chores
- (**claude**) add claude.md - ([7f44dcc](https://github.com/tao3k/omni-dev-fusion/commit/7f44dcc5bd4f69cbada700a79424756a9cc1a05a)) - guangtao
- (**cli**) fix scopes - ([03fb2ae](https://github.com/tao3k/omni-dev-fusion/commit/03fb2ae8f5460145be20a946ee8e0a46948be450)) - guangtao
- (**docs**) update documentation for Spec-Driven Development and pytest testing - ([d9d7a7e](https://github.com/tao3k/omni-dev-fusion/commit/d9d7a7e4fd9ab880c5c7c2f349351225bc601be5)) - guangtao
- (**git-ops**) refactor output.py to English-only documentation - ([1202ee8](https://github.com/tao3k/omni-dev-fusion/commit/1202ee8f3c5aa4450fb8bb0442323f1c0e32d7f2)) - guangtao
- (**git-ops**) clean up output.py registration - ([0f341d6](https://github.com/tao3k/omni-dev-fusion/commit/0f341d6e8deb6a7532ea2883ac45e8191d954eab)) - guangtao
...
- (**mcp**) remove orphaned personas.py (moved to mcp_core/inference.py) - ([c5f1a83](https://github.com/tao3k/omni-dev-fusion/commit/c5f1a834bd56340a51e1ebd346c15a342630da58)) - guangtao
- (**nix**) add legacy mcp-server scope for old commits - ([882f620](https://github.com/tao3k/omni-dev-fusion/commit/882f620901d2dcac7a43d10254dd67d98fb1c5c5)) - guangtao
- (**version**) v2.2.0 - ([695e17c](https://github.com/tao3k/omni-dev-fusion/commit/695e17c68e735b568243b45b8fc9d84bcea2745d)) - guangtao
- (**version**) v2.1.0 - ([7228cc9](https://github.com/tao3k/omni-dev-fusion/commit/7228cc91ece5d61424a1a3dfa9d3c593b89cf66f)) - guangtao
- (**version**) v2.0.0 - ([b3f97ae](https://github.com/tao3k/omni-dev-fusion/commit/b3f97aefcc25f9b18c0ca37e9e5ebb712f831118)) - guangtao
- (**version**) start v1.4.0 development - ([2577311](https://github.com/tao3k/omni-dev-fusion/commit/257731170ca88f9ce04b259ecde9af36522bd088)) - guangtao
- (**version**) v1.3.0 - ([ff18e5e](https://github.com/tao3k/omni-dev-fusion/commit/ff18e5e887745fdf33b5e51d93faecb862665080)) - guangtao
- (**version**) v1.4.0 - ([0eeff58](https://github.com/tao3k/omni-dev-fusion/commit/0eeff58deda8f99722065c8678eaf85b2ba43e0e)) - guangtao
- (**version**) v1.1.0 - ([d611cba](https://github.com/tao3k/omni-dev-fusion/commit/d611cba2e40c576b7b7090e2a2f4d843350baa0e)) - guangtao
- (**version**) v1.0.0 - ([aed658a](https://github.com/tao3k/omni-dev-fusion/commit/aed658a5eecebfebbc8788bcccc8c7f046413723)) - guangtao
- (**version**) v0.1.0 - ([0521775](https://github.com/tao3k/omni-dev-fusion/commit/0521775052647de53f368e0208afec7e50e327cc)) - guangtao
- add hello.py script - ([14dff77](https://github.com/tao3k/omni-dev-fusion/commit/14dff7774d298c60992bc53a188261d74c384951)) - guangtao
- remove Vale linting for LLM-generated documentation - ([0b67ffe](https://github.com/tao3k/omni-dev-fusion/commit/0b67ffeb006e6c01c52da820f72f6973988e4bed)) - guangtao
- sync formatting and manifest updates - ([797aa0b](https://github.com/tao3k/omni-dev-fusion/commit/797aa0b6998d2c604bbda93044b44137284106e7)) - guangtao
...
- merge v1.3.0 release - ([1482fd8](https://github.com/tao3k/omni-dev-fusion/commit/1482fd8ddcc1b2646ee76ddeee75859458029a57)) - guangtao
- sync with release - ([7e7d052](https://github.com/tao3k/omni-dev-fusion/commit/7e7d0521051ffb7c11b495681d7c9d58e3b450dc)) - guangtao
- switch secrets provider from 1Password to dotenv - ([b099f1e](https://github.com/tao3k/omni-dev-fusion/commit/b099f1e95231e4eeb93ba079e9c68d87afb845f8)) - guangtao
- remove hunspell and typos from lefthook pre-commit - ([f0baf4a](https://github.com/tao3k/omni-dev-fusion/commit/f0baf4a198839835a414b913613c94950a5ad1da)) - guangtao
- follow numtide/prj-spec for project directories - ([c6dfd6c](https://github.com/tao3k/omni-dev-fusion/commit/c6dfd6cdbd2ea8c602d6ddf5aea5c3fa41c889b0)) - guangtao
- add mcp test commands and infrastructure - ([125546c](https://github.com/tao3k/omni-dev-fusion/commit/125546c9da825de174d713e120791e7f5cd2e9e0)) - guangtao
- add omnibus devenv inputs filtering example to tool-router - ([df314f7](https://github.com/tao3k/omni-dev-fusion/commit/df314f7c909cc29d10891c089f9bbaee09278b45)) - guangtao
- add tool-router example protocol to CLAUDE.md - ([44aacfc](https://github.com/tao3k/omni-dev-fusion/commit/44aacfca319295f7cd3707873a45e6df40a8a548)) - guangtao
- add tool-router with nix edit protocol examples - ([55f61a3](https://github.com/tao3k/omni-dev-fusion/commit/55f61a367042225bb09f074e2ae4cba1030cf1dc)) - guangtao
- add mcp debug commands to justfile - ([5256d1f](https://github.com/tao3k/omni-dev-fusion/commit/5256d1fc95e092d1ac02803422cacff2e07e7bf5)) - guangtao
- sync with release - ([c928e7f](https://github.com/tao3k/omni-dev-fusion/commit/c928e7f62d6a789cdb0323751bd6fbdabc39baf2)) - guangtao
- stage local settings - ([488df87](https://github.com/tao3k/omni-dev-fusion/commit/488df879cb55e3a467eb54b4012296d0f03b6f9b)) - guangtao
- update project name references to omni-devenv-fusion - ([cad251c](https://github.com/tao3k/omni-dev-fusion/commit/cad251c372c23b4458478a98a1ac23c93e8977f7)) - guangtao
- formalize agent workflow with SRE health checks - ([048fc0b](https://github.com/tao3k/omni-dev-fusion/commit/048fc0bdddeccbd0ea43333cf65d70c3a66ec480)) - guangtao
- sync with release - ([70cf5f4](https://github.com/tao3k/omni-dev-fusion/commit/70cf5f40388772e0a145ccaa3f2dac50287fff15)) - guangtao
- init - ([5215ac9](https://github.com/tao3k/omni-dev-fusion/commit/5215ac951e138bb1d52350beedb0ff1381da9ed1)) - guangtao
#### Style
- (**cli**) format all files with prettier and nixfmt - ([32b4df5](https://github.com/tao3k/omni-dev-fusion/commit/32b4df50cb5ec7714b5ba8cf12f99162a6bbaf59)) - guangtao
- format documentation-workflow.md - ([4ff2a43](https://github.com/tao3k/omni-dev-fusion/commit/4ff2a434453561440566280401d7d4d544bccb55)) - guangtao
- format mcp-server/README.md - ([4885c28](https://github.com/tao3k/omni-dev-fusion/commit/4885c2860f985dc7c053637d57d915d9b3d48b42)) - guangtao
- format docs with prettier (start_spec updates) - ([2c4e069](https://github.com/tao3k/omni-dev-fusion/commit/2c4e069ef9b7ca95d07ef9be7b39f68247bf68fb)) - guangtao
