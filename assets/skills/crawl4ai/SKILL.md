---
name: crawl4ai
description: Complete toolkit for web crawling and data extraction using Crawl4AI. This skill should be used when users need to scrape websites, extract structured data, handle JavaScript-heavy pages, crawl multiple URLs, or build automated web data pipelines.
version: 1.0.0
authors: ["crawl4ai"]
execution_mode: subprocess
routing_keywords: ["crawl", "scrape", "web", "extract", "scraping"]
---
...
### CLI with Beautiful Rendering

Render crawled markdown with `glow` for beautiful terminal output:

```bash
uv run omni skill run crawl4ai.crawl_webpage \
  '{"url": "https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills", "fit_markdown": true}' | glow
```

![Glow rendering](https://github.com/charmbracelet/glow/raw/main/docs/demo.png)
