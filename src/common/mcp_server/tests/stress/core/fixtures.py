...
Provides reusable test environments with automatic cleanup.
"""
import asyncio
import shutil
...
from .. import StressConfig, get_config, BenchmarkRunner, LogicTestRunner, StabilityTestRunner, StressReporter
...
def stress_dir(tmp_path: Path) -> Path:
    ...
    yield stress_dir
    # Cleanup handled by tmp_path automatic cleanup


@pytest.fixture
def stress_env(stress_dir: Path, stress_config: StressConfig) -> AsyncGenerator[tuple[Path, StressConfig], None]:
...
# =============================================================================
# Helper Fixtures for Specific Tests
# =============================================================================
