...
- [x] Spec Kit 2.0: draft/verify/archive feature specs
- [x] Backmark: Persistent memory in .cache/<namespace>/.memory
- [x] Flight Recorder: Auto-log commands to SCRATCHPAD.md
- [x] OODA Loop: Debug Protocol for self-healing
- [x] Config-Driven GitOps: Read scopes from cog.toml

## 📚 Backlog

- Add Vale spelling checks for docs
- Enhance MCP tool documentation
- Optimize tool-router examples
